...
class ProfessionalVideoPlayerController extends GetxController with GetTickerProviderStateMixin {
  ...
  void _setupVideoPlayer() {
    ...
    try {
      ...
      debugPrint('Video player creation error: $e');
      _hasError.value = true;
    }
  }
  ...
  /// Enhanced volume control with better feedback
  ...
  /// Enhanced volume adjustment with better sensitivity - Fixed volume state management
  ...
  void handleVerticalDrag(double tapPosition, double screenWidth, double delta) {
  ...
  int get volumePercentage => (_isMuted.value ? 0 : (_currentVolume.value * 100)).round();
